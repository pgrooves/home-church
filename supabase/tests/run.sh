...
MIGS=${*:-"0016_group_rooms 0017_group_rooms_grants 0018_group_rooms_anon 0019_group_reports_resolve 0020_group_word_filter 0021_group_answer_index 0022_group_retention_schedule"}
